...
const LipsPage = () => {
    ...
    const fetchData = async () => {
        try {
            ...
            const {data} = await axios.get("https://enhanceserver.gisellesamanthawong.online" + "/productByCategoryId/3", {headers: {
...
return(
  ...
  <section className="py-10 bg-gray-100">
    ...
    <div>
    <h1 className="text-center text-2xl font-bold text-gray-800">EYES</h1>
    </div>
