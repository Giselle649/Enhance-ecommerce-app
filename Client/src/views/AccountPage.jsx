    ...
    const getData = async () => {
        try {
          const token = localStorage.getItem('access_token');
            ...
            const {data} = await axios.get("https://enhanceserver.gisellesamanthawong.online" + "/user", {headers: {
  ...
  const formOnSubmitHandler = async (event) => {
    ...
    try {
      ...
      setLoading(true)
        ...
        await axios.put("https://enhanceserver.gisellesamanthawong.online" + "/user", eachProduct, {headers: {
              Authorization: `Bearer ${token}`,
            }})
